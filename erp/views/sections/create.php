...
<div class="mb-6">
    <div class="flex items-center space-x-3 mb-2">
        ...
        <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Add New Section</h1>
    </div>
...
<form action="?module=sections&action=store" method="POST" class="bg-white rounded-xl shadow-sm border border-bordercolor overflow-hidden max-w-3xl">
    <div class="px-6 py-4 border-b border-bordercolor bg-slate-50 flex items-center">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500 mt-0.5">Define a section and assign a class teacher.</p>
        </div>
    </div>
    ...
    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <input type="text" name="name" required placeholder="e.g. A, B, Morning Batch" class="w-full px-4 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" name="room_number" placeholder="e.g. Room 101" class="w-full px-4 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary">
        </div>
        <div>
